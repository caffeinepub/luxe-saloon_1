...
export class Backend implements backendInterface {
    ...
    async bookAppointment(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: bigint, arg5: bigint, arg6: string, arg7: string | null): Promise<Appointment> {
        if (this.processError) {
            try {
                const result = await this.actor.bookAppointment(arg0, arg1, arg2, arg3, arg4, arg5, arg6, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg7));
    ...
    async getAllStylists(): Promise<Array<Stylist>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllStylists();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAvailableTimeSlots(arg0: bigint, arg1: bigint): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async getGalleryItemById(arg0: bigint): Promise<GalleryItem> {
        if (this.processError) {
            try {
                const result = await this.actor.getGalleryItemById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStylistById(arg0: bigint): Promise<Stylist> {
        if (this.processError) {
            try {
                const result = await this.actor.getStylistById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateAppointmentStatus(arg0: bigint, arg1: AppointmentStatus): Promise<Appointment> {
        if (this.processError) {
            try {
                const result = await this.actor.updateAppointmentStatus(arg0, to_candid_AppointmentStatus_n13(this._uploadFile, this._downloadFile, arg1));
                return from_candid_Appointment_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function to_candid_AppointmentStatus_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AppointmentStatus): _AppointmentStatus {
...
function to_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AppointmentStatus): {
    cancelled: null;
} | {
    pending: null;
} | {
